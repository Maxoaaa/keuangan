...
<!--kerjain kontennya disini-->
	...
	<div class="container-fluid">
      ...
      <div class="row">
      	<p style="background-color: #E7CEF0FF; height: 500px;border-radius: 30px;text-align: center; color:#45006BFF;font-size: 32px;line-height: 100px;padding: 20px;" class="ol-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">DISINI CHART UANG MASUK PEMBAYARAN DAN PENGELUARAN</p>
      </div>      
